/* ==========================================================
   SOSEEKS GEN AI ACADEMY — App Engine
   ========================================================== */

const ACCESS_CODE = 'SOSEEKS2026';
const STORAGE_KEY = 'soseeks_genai';
...
class GenAIAcademy {
    ...
    showDashboard() {
        ...
        container.innerHTML = `
        <div class="dash-hero">
            <h1>Generative <span class="glow">AI</span></h1>
            <p>Master GenAI from LLM fundamentals to building a production-grade multi-tenant, multi-agent chatbot — with real-world analogies, architecture diagrams, and hands-on quizzes.</p>
        </div>
        <div class="dash-grid">
            ${MODULES.map(mod => {
